    ...
    <div class="main">
        ...
        <section class="site_content">
            ...
            <div class="content">
                ...
                <h1>Meet Medic</h1>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/36lSzUMBJnc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <hr>
                <h2>Medic description</h2>
                <div class="descriptions">
                    <img src="assets/img/medic.jpg" style="width: 150px; height: 150px;">
                ...
                <hr>
                <h2>Medic weapons settings</h2>
                
                <div class="reviews">
                    <div class="reviews_name">
                    <h1>Default Medic Healgun</h1>
                    </div>
                    <img src="assets/img/medic healgun.png">
                ...
                <div class="reviews">
                    <div class="reviews_name">
                        <h1>Default Medic pistol</h1>
                    </div>
                    <img src="assets/img/Medic pistol.png">
                    <div class="review_text">
                        40 bullets - Ammunition ready.
                    </div>
                    <div class="review_text">
                        150 bullets - Ammunition in reserve.
                    </div>
                    <div class="review_text">
                        10 dmg base damage and 30 dmg headshot.
                    </div>
                </div>  
                <div class="reviews">
                    <div class="reviews_name">
                        <h1>Default Medic Saw</h1>
                    </div>
                    <img src="assets/img/medic saw.png">
                    <div class="review_text">
