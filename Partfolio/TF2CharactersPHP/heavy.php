    ...
    <div class="main">
        ...
        <section class="site_content">
            ...
            <div class="content">
                ...
                <h1>Meet Heavy</h1>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/jHgZh4GV9G0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <hr>
                <h2>Heavy description</h2>
                <div class="descriptions">
                    <img src="assets/img/Heavy.jpg" style="width: 150px; height: 150px;">
                ...
                <hr>
                <h2>Heavy weapons settings</h2>
                
                <div class="reviews">
                    <div class="reviews_name">
                    <h1>Default Heavy Minigun</h1>
                    </div>
                    <img src="assets/img/heavyminigun.png">
                    <div class="review_text">
                    200 bullets - Ammunition ready.
                    </div>
                    <div class="review_text">
                    9 dmg base damage and 27 dmg headshot.
                    </div>
                </div>
                <div class="reviews">
                    <div class="reviews_name">
                        <h1> Default Heavy Shotgun</h1>
                    </div>
                    <img src="assets/img/heavyShootgun.png">
                    <div class="review_text">
                ...
                <div class="reviews">
                    <div class="reviews_name">
                        <h1> Default Heavy Fists</h1>
                    </div>
                    <img src="assets/img/heavyfists.png">
                    <div class="review_text">
